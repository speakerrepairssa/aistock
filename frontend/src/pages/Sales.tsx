  ...
  return (
    <Container maxWidth="lg" sx={{ py: 4 }}>
      ...
      <Dialog open={openDialog} onClose={() => setOpenDialog(false)} maxWidth="md" fullWidth>
        ...
        >
          <Tab label="Customer Info" sx={{ textTransform: 'none' }} />
          <Tab label="Items" sx={{ textTransform: 'none' }} />
          <Tab label="Notes & Summary" sx={{ textTransform: 'none' }} />
        </Tabs>
        <DialogContent sx={{ pt: 3, display: 'flex', flexDirection: 'column', gap: 2, minHeight: 400 }}>
          {/* Tab Panel 0: Customer Info */}
          {activeTab === 0 && (
            <Box>
          ...
          {/* Tab Panel 2: Notes & Summary */}
          {activeTab === 2 && (
            <Box>
              <Typography variant="h6" sx={{ mb: 2 }}>Notes & Summary</Typography>
              ...
              <Card sx={{ backgroundColor: '#f9f9f9' }}>
                <CardContent>
                  ...
                  <Box sx={{ mb: 2 }}>
                    ...
                    <Typography variant="body1" sx={{ fontWeight: 600 }}>{items.length}</Typography>
                  </Box>
                  ...
                  <Box sx={{ pt: 2, borderTop: '2px solid #ddd' }}>
        ...
        <DialogActions>
          <Button onClick={() => { setOpenDialog(false); setActiveTab(0); }}>Cancel</Button>
          <Button 
