...
const CustomerDialog: React.FC<{open: boolean; onClose: () => void; customer?: Customer | null; mode?: string}> = ({ open, onClose }) => (
  <Dialog open={open} onClose={onClose}><DialogTitle>Customer Dialog</DialogTitle></Dialog>
);
const CreditNoteDialog: React.FC<{open: boolean; onClose: () => void; customer?: Customer | null; mode?: string}> = ({ open, onClose }) => (
  <Dialog open={open} onClose={onClose}><DialogTitle>Credit Note Dialog</DialogTitle></Dialog>
);
const RecurringInvoiceDialog: React.FC<{open: boolean; onClose: () => void; customer?: Customer | null; mode?: string}> = ({ open, onClose }) => (
  <Dialog open={open} onClose={onClose}><DialogTitle>Recurring Invoice Dialog</DialogTitle></Dialog>
);
